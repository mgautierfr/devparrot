...
to_test = {
                     ...
                     "function arg1 arg2 key1=value1 key2=value2" : Pipe(index=0,
                      ...
                      "function1 | function2"                  : Pipe(index=0,
                                                                      ...
                                                                      values=[CommandCall(index=0,
                                                                              ...
                                                                              Identifier(index=12, len=9, name="function2")
                                                                             ]
                                                                     ),
                      "function1 arg| function2"               : Pipe(index=0,
                                                                      ...
                                                                      values=[CommandCall(index=0,
                                                                              ...
                                                                              Identifier(index=15, len=9, name="function2")
                                                                             ]
                                                                     ),
                      "function1 arg \n function2"             : Pipe(index=0,
                                                                      ...
                                                                      values=[CommandCall(index=0,
                                                                              ...
                                                                              "\n",
                                                                              Identifier(index=16, len=9, name="function2")
                                                                             ]
                                                                     ),
          ...
          "function1 arg1 arg2 %macro1(arg1, %macro2, key='value ') key1=value1 | function2 arg3 %macro3(key2=%%macro4 " :
                     Pipe(index=0, len=108,
                      values=[CommandCall(index=0, len=68,
                               name="function1",
                               closed=True,
                               values=[UnquotedString(index=10, len=4,
                                         closed=True,
                                         values="arg1"),
                                       UnquotedString(index=15, len=4,
                                         closed=True,
                                         values="arg2"),
                                       MacroCall(index=20, len=36,
                                         opened=True,
                                         closed=True,
                                         expanded=False,
                                         name="macro1",
                                         values=[UnquotedString(index=28, len=4,
                                                  closed=True,
                                                  values="arg1"),
                                                 MacroCall(index=34, len=7,
                                                  opened=False,
                                                  closed=False,
                                                  expanded=False,
                                                  name="macro2",
                                                  values=[]),
                                                 KeywordArg(index= 43, len=12,
                                 ...
                                 CommandCall(index=71, len=37,
                                    name="function2",
                                    closed=False,
                                    values=[UnquotedString(index=81, len=4,
                                               closed=True,
                                               values="arg3"),
                                            MacroCall(index=86, len=21,
                                               opened=True,
                                               closed=False,
                                               expanded=False,
                                               name="macro3",
...
def test_parse_tokens(string_to_test):
    parsed = parser(string_to_test, forCompletion=True)
    parsed.pprint("")
...
def test_parse_invalid(string_to_test_invalid):
    with pytest.raises(InvalidSyntax):
         parser(string_to_test_invalid, forCompletion=True)

...
from textHighlight.lexer import RegexLexer, DelegatingLexer, bygroups, include, \
     using, this
from textHighlight.token import Punctuation, \
     Text, Comment, Operator, Keyword, Name, String, Number, Literal, Other
from textHighlight.util import get_choice_opt
from textHighlight.import unistring as uni

from textHighlight.lexers.web import XmlLexer

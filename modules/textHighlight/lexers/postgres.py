...
from textHighlight.lexer import Lexer, RegexLexer, do_insertions
from textHighlight.token import Punctuation, \
     Text, Comment, Operator, Keyword, Name, String, Number, Generic
from textHighlight.lexers import get_lexer_by_name, ClassNotFound

from textHighlight.lexers._postgres_builtins import KEYWORDS, DATATYPES, \

...
from textHighlight.lexer import RegexLexer, ExtendedRegexLexer, bygroups, using, \
     include, this
from textHighlight.token import Text, Comment, Operator, Keyword, Name, String, \
     Number, Other, Punctuation, Literal
from textHighlight.util import get_bool_opt, get_list_opt, looks_like_xml, \
                          html_doctype_matches
from textHighlight.lexers.agile import RubyLexer
from textHighlight.lexers.compiled import ScalaLexer
...
class PhpLexer(RegexLexer):
    ...
    `disabledmodules`
        ...
        .. sourcecode:: pycon
            ...
            >>> from textHighlight.lexers._phpbuiltins import MODULES
            >>> MODULES.keys()

...
from textHighlight.lexer import RegexLexer, bygroups, include
from textHighlight.token import Text, Keyword, Number, Comment, Punctuation, Name, \
    String

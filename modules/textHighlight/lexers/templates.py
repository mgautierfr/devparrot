# -*- coding: utf-8 -*-
"""
    textHighlight.lexers.templates
    ~~~~~~~~~~~~~~~~~~~~~~~~~
...
from textHighlight.lexers.web import \
     PhpLexer, HtmlLexer, XmlLexer, JavascriptLexer, CssLexer
from textHighlight.lexers.agile import PythonLexer, PerlLexer
from textHighlight.lexers.compiled import JavaLexer
from textHighlight.lexer import Lexer, DelegatingLexer, RegexLexer, bygroups, \
     include, using, this
from textHighlight.token import Error, Punctuation, \
     Text, Comment, Operator, Keyword, Name, String, Number, Other, Token
from textHighlight.util import html_doctype_matches, looks_like_xml
...
class ErbLexer(Lexer):
    ...
    def __init__(self, **options):
        from textHighlight.lexers.agile import RubyLexer

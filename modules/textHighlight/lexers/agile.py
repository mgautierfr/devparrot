...
from textHighlight.lexer import Lexer, RegexLexer, ExtendedRegexLexer, \
     LexerContext, include, combined, do_insertions, bygroups, using, this
from textHighlight.token import Error, Text, Whitespace, Other, \
     Comment, Operator, Keyword, Name, String, Number, Generic, Punctuation
from textHighlight.util import get_bool_opt, get_list_opt, shebang_matches
from textHighlight import unistring as uni
...
# b/w compatibility
from textHighlight.lexers.functional import SchemeLexer
...
class LuaLexer(RegexLexer):
    ...
    `disabled_modules`
        ...
        .. sourcecode:: pycon
            ...
            >>> from textHighlight.lexers._luabuiltins import MODULES
            >>> MODULES.keys()

...
def guess_lexer_for_filename(_fn, _text, **options):
    ...
    usage::
        ...
        >>> from textHighlight.lexers import guess_lexer_for_filename
        >>> guess_lexer_for_filename('hello.html', '<%= @foo %>')
        <textHighlight.lexers.templates.RhtmlLexer object at 0xb7d2f32c>
        >>> guess_lexer_for_filename('hello.html', '<h1>{{ title|e }}</h1>')
        <textHighlight.lexers.templates.HtmlDjangoLexer object at 0xb7d2f2ac>
        >>> guess_lexer_for_filename('style.css', 'a { color: <?= $link ?> }')
        <textHighlight.lexers.templates.CssPhpLexer object at 0xb7ba518c>
    """
    fn = basename(_fn)
    primary = None
    matching_lexers = set()
...
oldmod = sys.modules['textHighlight.lexers']
newmod = _automodule('textHighlight.lexers')
newmod.__dict__.update(oldmod.__dict__)
sys.modules['textHighlight.lexers'] = newmod

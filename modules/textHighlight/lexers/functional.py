# -*- coding: utf-8 -*-
"""
    textHighlight.lexers.functional
    ~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from textHighlight.lexer import Lexer, RegexLexer, bygroups, include, do_insertions
from textHighlight.token import Text, Comment, Operator, Keyword, Name, \
...
class CommonLispLexer(RegexLexer):
    ...
    *New in Pygments 0.9.*
    ...
    def __init__(self, **options):
        from textHighlight.lexers._clbuiltins import BUILTIN_FUNCTIONS, \
    ...
    *New in Pygments 0.9.*
    ...
    def get_tokens_unprocessed(self, text):
        ...
        if style == 'bird':
            ...
            # latex-style
            from textHighlight.lexers.text import TexLexer

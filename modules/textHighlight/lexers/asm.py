...
from textHighlight.lexer import RegexLexer, include, bygroups, using, DelegatingLexer
from textHighlight.lexers.compiled import DLexer, CppLexer, CLexer

...
from textHighlight.lexer import Lexer, LexerContext, RegexLexer, ExtendedRegexLexer, \
     bygroups, include, using, this, do_insertions
from textHighlight.token import Punctuation, Text, Comment, Keyword, Name, String, \
     Generic, Operator, Number, Whitespace, Literal
from textHighlight.util import get_bool_opt
from textHighlight.lexers.other import BashLexer
...
class RstLexer(RegexLexer):
    ...
    *New in Pygments 0.7.*
    ...
    def _handle_sourcecode(self, match):
        from textHighlight.lexers import get_lexer_by_name
        from textHighlight.util import ClassNotFound
...
class VimLexer(RegexLexer):
    ...
    *New in Pygments 0.8.*
    ...
    def __init__(self, **options):
        from textHighlight.lexers._vimbuiltins import command, option, auto
        self._cmd = command
        self._opt = option
        self._aut = auto

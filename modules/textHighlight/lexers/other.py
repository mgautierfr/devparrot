...
from textHighlight.lexer import Lexer, RegexLexer, include, bygroups, using, \
     this, do_insertions, combined
from textHighlight.token import Error, Punctuation, Literal, Token, \
     Text, Comment, Operator, Keyword, Name, String, Number, Generic
from textHighlight.util import shebang_matches
from textHighlight.lexers.web import HtmlLexer
...
class AsymptoteLexer(RegexLexer):
    ...
    *New in Pygments 1.2.*
    ...
    def get_tokens_unprocessed(self, text):
        from textHighlight.lexers._asybuiltins import ASYFUNCNAME, ASYVARNAME
